...
import br.com.gaspar.course.entities.*;
import br.com.gaspar.course.entities.enums.OrderStatus;
import br.com.gaspar.course.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        o1.setPayment(pay1);
        orderRepository.save(o1); // Payment é dependente de Order => Para salvar, tem que ser no orderRepository e não o paymentRepositoty.
